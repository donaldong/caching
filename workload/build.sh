...
$pin -t program/pintool/obj-intel64/instruction.so -o fib -- program/fib.o $fib_n 
$pin -t program/pintool/obj-intel64/data.so -o cyclic -- program/cyclic.o $n $k
$pin -t program/pintool/obj-intel64/instruction.so -o cyclic -- program/cyclic.o $n $k
